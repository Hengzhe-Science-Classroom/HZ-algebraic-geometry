// === Algebraic Geometry - Core Application ===
...
const App = {
    ...
    // --- Progress ---
    loadProgress() {
        try { this.progress = JSON.parse(localStorage.getItem('algebraic-geometry-progress') || '{}'); }
        catch (e) { this.progress = {}; }
    },
    saveProgress() {
        try { localStorage.setItem('algebraic-geometry-progress', JSON.stringify(this.progress)); } catch (e) {}
    },
